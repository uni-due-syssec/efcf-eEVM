...
namespace eevm
{
  class EVM2CPP_AdditionTest : public SpecializedProcessor
  {
    using SpecializedProcessor::SpecializedProcessor;

  private:
    static const std::string _contract_name;
    static const DerivedRegister<EVM2CPP_AdditionTest> reg;
  ...
  public:
    ...
    std::unique_ptr<SpecializedProcessor> duplicate() override {
      return std::make_unique<EVM2CPP_AdditionTest>();
    };
  };
}
